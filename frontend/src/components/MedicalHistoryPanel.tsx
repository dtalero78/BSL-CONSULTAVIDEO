      ...
      <div className="bg-[#2a3942] rounded-lg p-3">
        ...
        <div>
          ...
          >
            ...
            <option value="APTO PARA EL CARGO CON RECOMENDACIONES MÉDICO-LABORALES.">APTO PARA EL CARGO CON RECOMENDACIONES MÉDICO-LABORALES.</option>
            ...
            <option value="APTO PARA EL CARGO CON RECOMENDACIONES">APTO PARA EL CARGO CON RECOMENDACIONES</option>
